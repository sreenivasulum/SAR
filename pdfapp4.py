...
def map_fields(full_names,first_names,last_names,cities,dates,amounts):
    ...
    output_json["Text7"] = "NA"
    output_json["Text8"] = "NA"
    output_json["Text9"] = "NA"
    output_json["Text10"] = "NA"
    output_json["Text11"] = cities
    output_json["Text12d"] = "NA"
    output_json["Text12e"] = "NA"
    output_json["Text12f"] = "NA"
    output_json["Text13"] = "NA"
    output_json["item14"] = "NA"
    output_json["Text15"] = "NA"
...
output_json = map_fields(full_names[0],first_names[0],last_names[0],cities[0],dates[0],amounts[0])
fill_pdf('SAR-template.pdf', 'output.pdf', output_json)
